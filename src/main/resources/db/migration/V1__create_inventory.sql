...
-- Tabla micro.storage
-- ================================================
DROP TABLE IF EXISTS micro.storage CASCADE;
...
-- Tabla micro.supply
-- ================================================
DROP TABLE IF EXISTS micro.supply CASCADE;
...
CREATE TABLE IF NOT EXISTS micro.supply (
    ...
    CONSTRAINT fk_storage FOREIGN KEY (storage_id) REFERENCES micro.storage(id) ON DELETE CASCADE ON UPDATE CASCADE
);

-- ================================================
-- Tabla micro.warehouse_address
-- ================================================
DROP TABLE IF EXISTS micro.warehouse_address CASCADE;
...
CREATE TABLE IF NOT EXISTS micro.warehouse_address (
    ...
    CONSTRAINT fk_storage FOREIGN KEY (storage_id) REFERENCES micro.storage(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_address FOREIGN KEY (address_id) REFERENCES micro.address(id) ON DELETE CASCADE ON UPDATE CASCADE
);
